    ...
    def __init__(self):
        ...
        self.steps_data = [
            ["Intrinsics analysis",          # 0
             ...
             ["-i", "%input_dir%", "-o", "%matches_dir%", "-k", "3254.8108174801973;0;2030.0753918037567;0;3243.2048625811053;977.6552352878238;0;0;1"]],
            ["Compute features",             # 1
             os.path.join(OPENMVG_BIN, "openMVG_main_ComputeFeatures"),
             ["-i", "%matches_dir%"+FOLDER_DELIM+"sfm_data.json", "-o", "%matches_dir%", "-m", "SIFT", "-p", "ULTRA"]], 
            ["Compute pairs",                # 2
